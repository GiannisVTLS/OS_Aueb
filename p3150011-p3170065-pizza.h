...
const int T_order_low = 1;      // Time range in which a new order arrives
const int T_order_high = 5;

const int N_order_low = 1;      // Amount range of pizzas ordered
const int N_order_high = 5;

const int T_payment_low = 1;    // Time range in which the payment is completed
const int T_payment_high = 5;
...
const int T_delivery_low = 5;   // Time range that deliveries take
const int T_delivery_low = 15;
